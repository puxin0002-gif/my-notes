...
/**
 * 系統版本：v86.5 (變數重複宣告最終修復版)
 * 修正說明：
 * 1. [Fix] 移除重複宣告的 adminFilterActivities，解決 Build Error。
 * 2. [System] 完整整合 v86.2 所有功能 (資料總覽樣式重構)。
 */
