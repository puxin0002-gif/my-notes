...
/**
 * 系統版本：v60.0 (編譯錯誤修復與完整邏輯版)
 * 修正說明：
 * 1. [System] 修復 No input provided 錯誤，提供完整代碼。
 * 2. [Logic] 日期邏輯：過去日期不可選、自動同步、隱藏欄位自動清空。
 * 3. [Validation] 送出前強制檢查所有「可見」的日期欄位。
 * 4. [UI] 主色系 #4f093c，Logo 圓形，輸入框直角。
 * 5. [DB] 確保寫入正確的 null 值。
 */
