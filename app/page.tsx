...
/**
 * 系統版本：v66.0 (欄位順序調整與日期設定功能版)
 * 修正說明：
 * 1. [UI] 登記表單：將「義工組別」移至「抵離寺」下方。
 * 2. [Feature] 設定頁籤：新增「活動結束日」與「行程結束日」設定及連動邏輯。
 * 3. [Feature] 紀錄頁籤：實作地點篩選、自訂排序、卡片內容重組、狀態色塊邏輯。
 * 4. [System] 保持所有日期同步與防呆驗證邏輯。
 */
