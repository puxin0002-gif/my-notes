...
/**
 * 系統版本：v86.1 (變數重複宣告修復版)
 * 修正說明：
 * 1. [Fix] 移除重複宣告的 adminFilterActivities，解決 Build Error。
 * 2. [System] 完整整合 v86.0 所有功能 (資料總覽重構、欄位順序、狀態邏輯)。
 */
...
export default function App() {
  ...
  // v84.0 Data Table Sorting & Filtering (Refined)
